...
type WebsiteSettingsDocument = InferSchemaType<typeof websiteSettingsSchema>;

const WebsiteSettings =
  (models.WebsiteSettings as Model<WebsiteSettingsDocument>) ||
  model<WebsiteSettingsDocument>("WebsiteSettings", websiteSettingsSchema);
