...
export function Testimonials({
  ...
  const visible = useMemo(
    () =>
      testimonials.slice(normalizedActive, normalizedActive + visibleCount),
    [normalizedActive, testimonials, visibleCount]
  );

  return (
    <section id="testimonials" className="section-shell overflow-hidden">
      ...
      <div className="relative z-10">
        <SectionHeading
          ...
          description="Long-term partnerships, honest collaboration and outcomes that stand up after launch."
        >
          Trusted by clients.
          <br />
        ...
        <div className="mt-8 min-h-[280px]">
          <AnimatePresence mode="popLayout" initial={false}>
            <motion.div
              key={`${normalizedActive}-${visibleCount}`}
