...
type ThemeMode = WebsiteSettings["defaultMode"];
...
function applyTheme(settings: WebsiteSettings, mode: ThemeMode) {
...
export function ThemeProvider({
  ...
  const [settings, setSettings] = useState(() =>
    mergeThemeSettings(initialSettings)
  );
  const [mode, setModeState] = useState<ThemeMode>(() => {
    if (typeof window === "undefined") return initialSettings.defaultMode;
  ...
  const updateSettings = useCallback((nextSettings: WebsiteSettings) => {
