...
import { buildThemeCssVariables, getWebsiteSettings, } from "@/lib/theme-settings";
import "./globals.css";
const inter = Inter({
    variable: "--font-inter",
    subsets: ["latin"],
...
const siteUrl = process.env.NEXT_PUBLIC_SITE_URL ?? "https://novaforge.example.com";
export const metadata = {
    ...
    description: "hike agency is an independent digital agency creating high-converting websites, e-commerce experiences, brands, and growth systems.",
    keywords: [
        "digital agency",
        "web design",
        "web development",
    ...
    openGraph: {
        ...
        description: "Strategy, design, development, and growth for ambitious brands.",
        type: "website",
        url: siteUrl,
...
export default async function RootLayout({ children, }) {
    ...
    return (<html lang="en" data-theme={settings.defaultMode} style={buildThemeCssVariables(settings)} suppressHydrationWarning>
